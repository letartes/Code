...
Detected liabilities (same as v1):
  ...
  - Truncation    : DP bond, N-term E/Q pyroglutamate, C-term K clipping, N-term Met
...
LIABILITIES = {
    ...
    "trunc_medium": {
        "label": "Truncation – Medium Risk (C-term clipping)",
        "short": "Trunc-M",
        "category": "Truncation",
        "risk": "medium",
        "color_text": "#784212",
        ...
        "color_border": "#f39c12",
        "description": (
            "C-terminal lysine clipping is a common post-translational modification "
            "in CHO-expressed mAbs driven by carboxypeptidase activity. "
